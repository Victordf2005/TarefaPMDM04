...
public class VerCompras extends AppCompatActivity {
    ...
    // Método para obter e amosar os datos do cliente
    private void amosarDatosCliente() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!temosPermiso()) {
                ActivityCompat.requestPermissions(VerCompras.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
            } else {
                permisoGaleria=true;
            }
        }
        ...
        if (permisoGaleria) {
            ...
            if (!(bitmap == null)) {
                ...
                // Escalamos a imaxe segundo a densidade do dispositvo
    ...
    // Método que devolve se temos permiso de acceso á galéria
